        ...
        <div className="flex flex-col md:flex-row items-start md:items-center justify-start md:justify-between w-full">
          ...
          <div className="w-full md:px-6 mt-3 md:mt-0">
            ...
            <nav className="hidden lg:block">
              <ul className="flex space-x-6 items-center text-gray-400 justify-start">
                {navLinks.map((nav, idx) =>
                  nav.isSubMenu ? (
                    <li key={idx}>
                      ...
                      >
                        <HeadlessMenu.Button className="flex items-center gap-1 cursor-pointer text-gray-600 hover:text-gray-900 tracking-tight">
                          {nav.title}
