...
export default function LineupModels({ make }) {
  ...
  return (
    <section className="w-full section-container text-black">
      <h2 className="text-2xl font-bold mb-6">Lineup Models for {make}</h2>
              ...
              <Slider {...sliderSettings}>
                {currentModels.map((model) => (
                  <div key={model.id} className="px-2">
                    <div className="border border-slate-300 rounded p-2 md:p-6 bg-white shadow-sm min-h-[200px] flex flex-col md:flex-row gap-4 md:gap-6 items-center">
