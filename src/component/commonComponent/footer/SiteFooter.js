                ...
                <div className="page-container">
                    ...
                    <div className="grid grid-cols-1 lg:grid-cols-3 lg:gap-6 ">
                        <div>
                            ...
                            <div className="mt-4">
                                <p className="text-white text-xs">**See <span className="text-red-600">TERMS</span> for details. Plus, government fees & taxes, any finance charges, any dealer document processing charge, any electronic filing charge, emission testing charge, Freight (Transportation to Dealer) & Additional Dealer Markup (A.D.M.). These charges are subject to change without notice. Pricing may exclude any added parts, accessories or installation unless otherwise noted. ALL SALE PRICES INCLUDE FACTORY INCENTIVES.</p>
                            </div>
